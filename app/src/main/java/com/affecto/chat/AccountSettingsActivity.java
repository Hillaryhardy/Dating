...
import com.affecto.chat.dialogs.AlcoholViewsSelectDialog;
import com.affecto.chat.dialogs.GenderSelectDialog;
import com.affecto.chat.dialogs.ImportantInOthersSelectDialog;
import com.affecto.chat.dialogs.PersonalPrioritySelectDialog;
import com.affecto.chat.dialogs.PoliticalViewsSelectDialog;
import com.affecto.chat.dialogs.RelationshipStatusSelectDialog;
import com.affecto.chat.dialogs.SexOrientationSelectDialog;
import com.affecto.chat.dialogs.SmokingViewsSelectDialog;
import com.affecto.chat.dialogs.WorldViewSelectDialog;
import com.affecto.chat.dialogs.YouLikeSelectDialog;
import com.affecto.chat.dialogs.YouLookingSelectDialog;
...
public class AccountSettingsActivity extends ActivityBase implements GenderSelectDialog.AlertPositiveListener, RelationshipStatusSelectDialog.AlertPositiveListener, PoliticalViewsSelectDialog.AlertPositiveListener, WorldViewSelectDialog.AlertPositiveListener, PersonalPrioritySelectDialog.AlertPositiveListener, ImportantInOthersSelectDialog.AlertPositiveListener, SmokingViewsSelectDialog.AlertPositiveListener, AlcoholViewsSelectDialog.AlertPositiveListener, YouLookingSelectDialog.AlertPositiveListener, YouLikeSelectDialog.AlertPositiveListener, SexOrientationSelectDialog.AlertPositiveListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.affecto.chat.R.layout.activity_account_settings);

        mToolbar = (Toolbar) findViewById(com.affecto.chat.R.id.toolbar);
        ...
        fragmentManager.beginTransaction().replace(com.affecto.chat.R.id.container_body, fragment).commit();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.affecto.chat.R.menu.menu_account_settings, menu);
        return true;
    }
