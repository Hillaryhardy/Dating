...
import com.affecto.chat.dialogs.HotgameSettingsDialog;
...
public class HotgameFragment extends Fragment implements Constants {
    ...
    LinearLayout mSpotLight, mPermissionSpotlight, mHotgameLayout;
    ...
    public CircularImageView mHotgameLike, mHotgameDislike;
...
//        setRetainInstance(true);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mHotgameLike = (CircularImageView) rootView.findViewById(R.id.hotgameLike);
        mHotgameDislike = (CircularImageView) rootView.findViewById(R.id.hotgameDislike);

        mHotgameProgressBar = (ProgressBar) rootView.findViewById(R.id.hotgameProgressBar);

        mHotgameLayout = (LinearLayout) rootView.findViewById(R.id.hotgameLayout);
    ...
    public void updateHotgameContainer() {
        ...
        if (itemsList.size() > 0 && position != -1 && (itemsList.size() - 1) >= position) {
            ...
            if (u.isMatch() || u.isMyLike()) {
                ...
                mHotgameLike.setImageResource(R.drawable.ic_hotgame_next);

            } else {

                mHotgameLike.setImageResource(R.drawable.ic_hotgame_like);
            }
            ...
            if (u.getNormalPhotoUrl() != null && u.getNormalPhotoUrl().length() > 0) {
                ...
                final LinearLayout layout = mHotgameLayout;
